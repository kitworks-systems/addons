                    ...
                    const onBlurFallback = () => {
                        requestAnimationFrame(async () => {
                            ...
                            if (root && root.querySelector(
                                ".o-autocomplete--dropdown-menu")) return;
                            const inputVal = inputEl.value || "";
                            const recordVal =
                                this.props.record.data[this.props.name] || "";
                            if (inputVal !== recordVal) {
                                await this.props.record.update({
                                    [this.props.name]: inputVal,
                                });
                            }
                        });
                    };
                    inputEl.addEventListener("blur", onBlurFallback);
                    return () =>
                        inputEl.removeEventListener("blur", onBlurFallback);
                }
            },
            () => [this.inputRef.el]
        );
